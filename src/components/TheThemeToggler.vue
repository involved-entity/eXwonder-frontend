<template>
  <nav class="shadow-theme-toggler w-full fixed top-0 left-0 h-[44px] flex justify-center items-center bg-gray-100 dark:bg-[#222] z-10" id="theme-toggler">
    <button class="text-black dark:text-white" type="button" @click="toggleTheme">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7" v-if="theme === 'dark'">
