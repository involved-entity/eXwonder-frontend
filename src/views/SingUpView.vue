    ...
    <div class="h-screen items-center flex justify-center gap-x-5">
      <div class="border border-gray-300 rounded-2xl w-2/5 h-3/4 relative" style="background-color: #222">
        ...
        <div class="absolute bottom-0 left-0 w-full">
          <p class="text-xl text-gray-300 mx-3 mb-1">Already have and account?
            <router-link :to="{name: 'login'}" class="border-b border-gray-300 hover:border-blue-600 hover:text-blue-600">Log in</router-link>
          </p>
        </div>
      </div>
